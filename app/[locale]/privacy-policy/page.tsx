		...
		<div className="py-8">
			...
			<header className="">
				<div className="max-w-4xl mx-auto px-4 py-6">
					<h1 className="text-3xl font-bold text-gray-900">NEPOS Web/App Privacy Policy</h1>
				...
				<div className="bg-white rounded-lg shadow-md p-8 space-y-8">
					...
					<section>
						...
						<div className="space-y-3">
							...
							<DataUseItem type="Phone Number" purpose="is used to send special communications from the NEPOS Team also the number is used in many cases for user authentication." />
					...
					<section>
						...
						<p className="text-gray-700 leading-relaxed">
							...
							<a href="mailto:info@NEPOSnorway.org" className="text-blue-600 hover:text-blue-800 underline">
								info@NEPOSnorway.org
							</a>{" "}
					...
					<section>
						...
						<p className="text-gray-700 leading-relaxed">NEPOS is a member-based party and your contributions is the bases on which the party operates. Please read the respective terms and conditions of the payment gateways app before donating.</p>
					</section>
