		...
		<div className="py-8">
			...
			<header className="">
				<div className="max-w-4xl mx-auto px-4 py-6">
					<h1 className="text-3xl font-bold text-gray-900">NEPOS App Terms and Conditions</h1>
			...
			<main className="max-w-4xl mx-auto px-4 py-8">
				<div className="bg-white rounded-lg shadow-md p-8 space-y-8">
					...
					<section className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 rounded-r-lg">
						...
						<p className="text-gray-800 leading-relaxed font-medium">BEFORE SUBMITTING ANY INFORMATION, TEXT, GRAPHICS, VIDEOS, PHOTOS OR OTHER MATERIAL (&quot;CONTENT&quot;) TO THE NEPOS APP YOU MUST READ AND AGREE TO THE TERMS OF THIS SUBMISSION AGREEMENT, WHICH APPLIES TO ALL CONTENT UPLOADED FROM YOUR ACCOUNT AT ANY TIME.</p>
					</section>

					{/* Submission Agreement */}
					<section>
						<h2 className="text-2xl font-semibold text-gray-900 mb-4">Submission Agreement</h2>
						<p className="text-gray-700 leading-relaxed">By submitting any content to the NEPOS App, you hereby agree that you are responsible for any Content that you submit and any consequences thereof.</p>
					</section>

					{/* Content Removal */}
					<section>
						<h2 className="text-2xl font-semibold text-gray-900 mb-4">Content Removal</h2>
						<p className="text-gray-700 leading-relaxed">You understand that any Content submitted on the NEPOS App can be removed if we believe that it violates these Terms of Service, our policies or any laws by which we are governed.</p>
					</section>
					...
					<section>
						...
						<div className="space-y-4">
							<ResponsibilityCard title="Privacy Policy Agreement" description="You further agree that any information that you or other users provide to the NEPOS APP is subject to our Privacy Policy, which governs our collection and use of information." />
					...
					<section>
						...
						<div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
							<p className="text-gray-700 leading-relaxed mb-4">You agree and acknowledge that the NEPOS App is not responsible for and does not control Content submitted and published by a third party.</p>
							<p className="text-gray-700 leading-relaxed">Under no circumstances will the NEPOS App be liable in any way for any Content, including, but not limited to, any errors or omissions in any Content, or any loss or damage of any kind incurred as a result of the use of any Content posted, emailed, transmitted or otherwise made available via the NEPOS App or broadcast elsewhere.</p>
						</div>
					</section>
					...
					<section className="border-t border-gray-200 pt-6">
						...
						<div className="flex flex-wrap gap-3">
							...
							<Link href="mailto:info@NEPOSnorway.org" className="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
								<svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<footer className="bg-white border-t border-gray-200 mt-12">
				<div className="max-w-4xl mx-auto px-4 py-6 text-center text-gray-600 text-sm">
					<p>© 2025 NEPOS Nepal. All rights reserved.</p>
					<p className="mt-1">By using the NEPOS App, you agree to these Terms and Conditions</p>
				</div>
			</footer>
		</div>
	);
