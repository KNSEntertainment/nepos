...
const opportunitiesData = [
	{
		...
		fullDescription: "As a Community Organizer, you'll be at the forefront of building strong local networks of Nepalis in Norway. You'll create meaningful connections, organize impactful events, and ensure NEPOS's vision reaches every corner of the Norwegian Nepali community.",
		responsibilities: ["Organize and coordinate local community events, meetups, and cultural programs", "Build and maintain relationships with local Nepali organizations and community leaders", "Recruit new members and volunteers for NEPOS", "Represent NEPOS values and principles at community gatherings", "Coordinate with the national team on local campaign initiatives", "Create monthly reports on community engagement activities"],
		...
		benefits: ["Leadership development opportunities", "Network with influential community members", "Access to NEPOS national events and training", "Certificate of recognition for your service", "Direct impact on community building"],
		timeCommitment: "5-10 hours per week",
		location: "Your local city in Norway",
		contact: "info@NEPOSnorway.org",
	},
	{
		id: "digital-activist",
		...
		fullDescription: "Digital Activists are the voice of NEPOS in the online world. You'll craft compelling narratives, engage with our community on social media, and help build NEPOS's digital presence across platforms. Your creativity and digital savvy will help us reach thousands.",
	...
	},
	{
		...
		shortDescription: "Help shape NEPOS's policies and strategic direction",
		icon: "📋",
		color: "bg-indigo-500",
		gradient: "from-indigo-400 to-indigo-600",
		fullDescription: "Policy Contributors are the intellectual backbone of NEPOS. You'll research critical issues facing Nepal, contribute to policy discussions, and help develop evidence-based positions on key matters. Your expertise will directly influence NEPOS's policy platform.",
	...
	},
	{
		...
		fullDescription: "Fundraising Team members ensure NEPOS has the resources to achieve its mission. You'll develop creative fundraising campaigns, build relationships with donors, and organize events that generate support for our cause while engaging the community.",
		...
		benefits: ["Fundraising expertise development", "Network with business leaders", "Event management experience", "Recognition for campaign success", "Direct impact on NEPOS's capacity"],
	...
	},
	{
		...
		fullDescription: "Youth Ambassadors are the bridge between NEPOS and Nepal's future leaders. You'll engage with young Nepalis in Norway, organize campus activities, and ensure youth voices are heard in party decisions. Your energy will inspire the next generation.",
		responsibilities: ["Organize youth-focused events, workshops, and discussions", "Build networks with student organizations and youth groups", "Recruit young members and volunteers", "Advocate for youth issues within NEPOS", "Manage youth social media channels", "Mentor younger members and new volunteers"],
	...
	},
	{
		...
		fullDescription: "Creative Team members bring NEPOS's message to life through stunning visuals. You'll design graphics, create videos, and develop creative materials that capture attention and inspire action. Your artistic vision will shape how people see NEPOS.",
		responsibilities: ["Design graphics for social media, events, and campaigns", "Create and edit videos for digital platforms", "Develop branding materials and visual guidelines", "Design posters, banners, and promotional materials", "Collaborate with other teams on creative needs", "Maintain NEPOS's visual identity consistency"],
